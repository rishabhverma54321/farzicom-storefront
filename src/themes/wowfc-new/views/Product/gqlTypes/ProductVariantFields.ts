...
export interface ProductVariantFields_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
...
export interface ProductVariantFields_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductVariantFields {
  ...
  weight: ProductVariantFields_weight | null;
  /**
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductVariantFields_metadata | null)[];
}
