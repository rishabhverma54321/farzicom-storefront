...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
   ...
   */
  metadata: (HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
  ...
  defaultVariant: HomePageQueryNext_subnavbar_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_homePageIcons_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_featuredCollections_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_ourOrganicRanges_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_whatsNew_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_purestCare_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_byConcern_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_customersSay_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_instagramShots_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_reasonsToLove_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_blogsSection_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: HomePageQueryNext_seedSection_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
