...
export interface CategoryProducts_products_edges_node_collections {
...
export interface CategoryProducts_products_edges_node_variants_images {
...
export interface CategoryProducts_products_edges_node_variants_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
...
export interface CategoryProducts_products_edges_node_variants_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CategoryProducts_products_edges_node_variants_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CategoryProducts_products_edges_node_variants_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: CategoryProducts_products_edges_node_variants_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: CategoryProducts_products_edges_node_variants_pricing_priceUndiscounted_net;
}

export interface CategoryProducts_products_edges_node_variants_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CategoryProducts_products_edges_node_variants_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface CategoryProducts_products_edges_node_variants_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: CategoryProducts_products_edges_node_variants_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: CategoryProducts_products_edges_node_variants_pricing_price_net;
}

export interface CategoryProducts_products_edges_node_variants_pricing {
   ...
   */
  priceUndiscounted: CategoryProducts_products_edges_node_variants_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: CategoryProducts_products_edges_node_variants_pricing_price | null;
}

export interface CategoryProducts_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface CategoryProducts_products_edges_node_variants_attributes_attribute {
   ...
   */
  metadata: (CategoryProducts_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface CategoryProducts_products_edges_node_variants_attributes_values {
...
export interface CategoryProducts_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: CategoryProducts_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (CategoryProducts_products_edges_node_variants_attributes_values | null)[];
}

export interface CategoryProducts_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface CategoryProducts_products_edges_node_variants {
   ...
   */
  images: (CategoryProducts_products_edges_node_variants_images | null)[] | null;
  weight: CategoryProducts_products_edges_node_variants_weight | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: CategoryProducts_products_edges_node_variants_pricing | null;
  /**
   * List of attributes assigned to this variant.
   */
  attributes: CategoryProducts_products_edges_node_variants_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (CategoryProducts_products_edges_node_variants_metadata | null)[];
}
...
export interface CategoryProducts_products_edges_node {
   ...
   */
  collections: (CategoryProducts_products_edges_node_collections | null)[] | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
   ...
   */
  variants: (CategoryProducts_products_edges_node_variants | null)[] | null;
}
