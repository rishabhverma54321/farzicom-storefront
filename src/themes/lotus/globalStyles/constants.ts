...
export const baseFontColor = "#1D2136";
...
export const secondaryLotus = "#686B78";
...
export const ratingDefault = "#FDC20C";
export const homeshowcaseGrey = "#F4F8F3";
export const checkoutButtonColor = "#345e2e";
export const checkoutButtonHoverColor = "#78a442";

export const goToCart = "#78a442";
export const goToCartHover = white;
...
export const theme = {
  ...
  secondary: secondaryLotus,
  secondaryDark: secondaryLotus,
  secondaryLight: secondaryLotus,
  secondaryOverlay: secondaryLotus,
  secondaryOverlayDark: secondaryLotus,
  ...
  white,
  loader: greenLight,
  homeHeaderText: greenLight,
  reviewTitle: greenDark,
  razorpayColor: greenLight,
  select,
  selectHover,
};

// typography
export const baseFontFamily = `"Rubik", sans-serif, Arial;`;
export const barkentinaFontFamily = "Barkentina";
...
export const headingFontFamily = `"Rubik", sans-serif, Arial;`;
export const subheadingFontFamily = `"Rubik", sans-serif, Arial;`;
export const titleFontFamily = `"Rubik", sans-serif, Arial;`;
export const archivoBlackFont = `"Rubik", sans-serif, Arial;`;
