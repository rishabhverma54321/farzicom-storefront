...
export interface ProductDetailsWithSection_product_category_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_product_category_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_product_category_products_edges_node_variants_metadata | null)[];
}
...
export interface ProductDetailsWithSection_product_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_product_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_product_variants_metadata | null)[];
}
...
export interface ProductDetailsWithSection_product_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_product_defaultVariant {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_product_defaultVariant_metadata | null)[];
}
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: ProductDetailsWithSection_section_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: ProductDetailsWithSection_section_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_thumbnail2x {
  __typename: "Image";
  /**
   * The URL of the image.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute_metadata | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes_values | null)[];
}
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_metadata | null)[];
  /**
   * List of attributes assigned to this variant.
   */
  attributes: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_variants_attributes[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price_net;
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing_price | null;
}

export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant {
  __typename: "ProductVariant";
  /**
   * The ID of the object.
   */
   ...
   * List of attributes assigned to this variant.
   */
  attributes: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_metadata | null)[];
  /**
   * Quantity of a product available for sale in one checkout.
   */
  quantityAvailable: number;
   ...
   * List of images for the product variant.
   */
  images: (ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_images | null)[] | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant_pricing | null;
}
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node {
   ...
   * The main thumbnail for a product.
   */
  thumbnail2x: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_thumbnail2x | null;
  /**
   * List of images for the product.
   */
  ...
  defaultVariant: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node_collections_edges_node_products_edges_node_defaultVariant | null;
  /**
   * Lists the storefront product's pricing, the current price and discounts, only meant for displaying.
   */
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges {
   ...
   * The item at the end of the edge.
   */
  node: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges_node;
}
...
export interface ProductDetailsWithSection_section_edges_node_children_edges_node_children {
  ...
  edges: ProductDetailsWithSection_section_edges_node_children_edges_node_children_edges[];
}
...
export interface ProductDetailsWithSection_section_edges_node_children_edges {
   ...
   * The item at the end of the edge.
   */
  node: ProductDetailsWithSection_section_edges_node_children_edges_node;
}

export interface ProductDetailsWithSection_section_edges_node_children {
  __typename: "SectionTypeCountableConnection";
  edges: ProductDetailsWithSection_section_edges_node_children_edges[];
}
...
export interface ProductDetailsWithSection_section_edges {
   ...
   * The item at the end of the edge.
   */
  node: ProductDetailsWithSection_section_edges_node;
}

export interface ProductDetailsWithSection_section {
  __typename: "SectionTypeCountableConnection";
  edges: ProductDetailsWithSection_section_edges[];
}
