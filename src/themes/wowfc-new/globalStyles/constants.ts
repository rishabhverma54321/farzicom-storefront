...
// typography
export const baseFontFamily = "CircularStdBook";
...
export const headingFontFamily = "CircularStdBlack";
export const subheadingFontFamily = "CircularStdBold";
export const titleFontFamily = "CircularStdBold";
export const archivoBlackFont = "CircularStdBook";
