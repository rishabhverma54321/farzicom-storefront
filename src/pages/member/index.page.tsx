...
import { membershipPageQuery } from "./queries";
...
export default function OrderHistoryPage({membershipData, headerAndFooterData, shopMeta }) {
  ...
  if (authenticated) {
    return (
      <Layout headerAndFooterData={headerAndFooterData} shopMeta={shopMeta}>
        <>
          <AccountSectionNext membershipData={membershipData}/>
        </>
      </Layout>
    );
  }
