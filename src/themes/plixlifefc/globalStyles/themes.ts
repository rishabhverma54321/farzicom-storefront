...
export const defaultTheme = {
  ...
  button: {
    ...
    colors: {
      primary: {
        ...
        color: C.black,
        hoverBackground: C.theme.pdpAddToCartBGColor,
        hoverColor: C.white,
        border: "none",
      },
      secondary: {
      ...
      applyCoupon: C.theme.secondary,
      savingButton: C.theme.primaryLight,
      searchResultOdd: "#FDF0F5",
      searchResultEven: "#f1fae6",
      heading: C.theme.primary,
    },
    padding: {
      main: "0.9rem 3.7rem",
      small: "0.9rem 1rem",
  ...
  colors: {
    ...
    checkoutButtonColor: C.theme.checkoutButtonColor,
    checkoutButtonHoverColor: C.theme.checkoutButtonHoverColor,
    searchResultOdd: "#EEFDEB",
    searchResultEven: "#E1FFDB",
