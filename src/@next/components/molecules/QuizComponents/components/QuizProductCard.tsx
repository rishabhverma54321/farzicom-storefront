  ...
  if (productVariant) {
    return (
      <>
        ...
        <div
          className={`${style.product_card} ${className}_quizpage_productList_card`}
        >
...
const QuizProductCard = ({
  ...
  if (products?.length) {
    return (
      <div
        className={`${style.quizpage_results_products} ${style.quizpage_padding} ${className}_quizpage`}
      >
        <div className={style.quizProduct_container}>
          <div>
            <h3 className={style.quizProduct_container_title}>
              {heading || "1 Month Skincare Regimen"}
            </h3>
            <div className={style.quizProduct_container_list}>
              ...
              <div
                className={`${style.quizProduct_container_list_cards} ${className}_quizpage_productList`}
              >
