...
export const greenLight = "#123258";
export const greenText = "#60b246";

// $violet: #e95f5f;

export const violet = "#e95f5f";
...
export const checkoutButtonColor = "#011e42";
export const checkoutButtonHoverColor = "#45a329";

export const goToCart = "#60b246";
...
export const theme = {
  ...
  secondaryDark: pink,
  secondaryLight: pink,
  secondaryOverlay: pink,
  secondaryOverlayDark: pink,
  ...
  reviewTitle: darkGreen,
  razorpayColor: greenLight,
  select: darkGreen,
  selectHover: greenLight,
};
...
export const headingFontFamily =
  "'Rammetto One', cursive, 'Courier New', monospace";
export const subheadingFontFamily = "'Archivo', sans-serif, Arial";
