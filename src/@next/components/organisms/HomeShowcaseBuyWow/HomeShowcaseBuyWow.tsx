...
export interface IHomeShowcaseBuyWowProps {
  id?: string;
...
export const HomeShowcaseBuyWow: React.FC<IHomeShowcaseBuyWowProps> = ({
  id,
  color,
  url,
  name,
...
HomeShowcaseBuyWow.displayName = "HomeShowcaseBuyWow";
export default React.memo(HomeShowcaseBuyWow);
