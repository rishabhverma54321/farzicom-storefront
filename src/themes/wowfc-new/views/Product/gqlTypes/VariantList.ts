...
export interface VariantList_productVariants_edges_node_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
...
export interface VariantList_productVariants_edges_node_attributes_attribute_metadata {
...
export interface VariantList_productVariants_edges_node_attributes_attribute {
   ...
   */
  metadata: (VariantList_productVariants_edges_node_attributes_attribute_metadata | null)[];
}
...
export interface VariantList_productVariants_edges_node_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface VariantList_productVariants_edges_node {
  ...
  weight: VariantList_productVariants_edges_node_weight | null;
  /**
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (VariantList_productVariants_edges_node_metadata | null)[];
