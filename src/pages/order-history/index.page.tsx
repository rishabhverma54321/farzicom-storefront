...
const AccuntInfo = ({targetRef,closeHandler,setshowLogoutpopup,showLogoutpopup}) =>{
  return(
    <>
      <UserInfo />
    </>
    ...
    if (order_token) {
      return (
        <Layout headerAndFooterData={headerAndFooterData} shopMeta={shopMeta}>
          <>
            <AccuntInfo  targetRef={targetRef} closeHandler={(e)=>closeHandler(e)} setshowLogoutpopup={setshowLogoutpopup} showLogoutpopup={showLogoutpopup} />
            <OrderDetail order_token={order_token} />
          </>
        </Layout>
      );
    }
