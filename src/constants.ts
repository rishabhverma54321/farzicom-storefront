export const apiUrl =
  process.env.NEXT_PUBLIC_API_URI || process.env.API_URI || "";
export const restApiUrl =
  process.env.NEXT_PUBLIC_REST_API_URL || process.env.REST_API_URL;
...
export const clientName = process.env.NEXT_PUBLIC_CLIENT;
