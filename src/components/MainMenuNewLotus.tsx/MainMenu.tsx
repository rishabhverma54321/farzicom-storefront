...
import searchImgLotus from "../../images/search-lotus.svg";
import cartImgLotus from "../../images/cart-lotus.svg";
              ...
              <nav className="lotus-main-menu" id="header">
                ...
                <div className="lotus-main-menu__lower">
                  <Media
                    ...
                    render={() => (
                      <>
                        <div className="lotus-main-menu__lower__desktop-left">
                          ...
                          <ul className="lotus-main-menu__lower__desktop-left__nav-row">
                            {items.map(item => (
                              <li
                        ...
                        <div className="lotus-main-menu__lower__desktop-right">
