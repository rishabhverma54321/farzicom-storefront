...
export interface ProductDetails_product_category_products_edges_node_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetails_product_category_products_edges_node_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetails_product_category_products_edges_node_variants_metadata | null)[];
}

export interface ProductDetails_product_category_products_edges_node_defaultVariant_images {
  __typename: "ProductImage";
  /**
   * The ID of the object.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_pricing_priceUndiscounted_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_pricing_priceUndiscounted {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetails_product_category_products_edges_node_defaultVariant_pricing_priceUndiscounted_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetails_product_category_products_edges_node_defaultVariant_pricing_priceUndiscounted_net;
}

export interface ProductDetails_product_category_products_edges_node_defaultVariant_pricing_price_gross {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_pricing_price_net {
  __typename: "Money";
  /**
   * Amount of money.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_pricing_price {
  __typename: "TaxedMoney";
  /**
   * Amount of money including taxes.
   */
  gross: ProductDetails_product_category_products_edges_node_defaultVariant_pricing_price_gross;
  /**
   * Amount of money without taxes.
   */
  net: ProductDetails_product_category_products_edges_node_defaultVariant_pricing_price_net;
}

export interface ProductDetails_product_category_products_edges_node_defaultVariant_pricing {
  __typename: "VariantPricingInfo";
  /**
   * Whether it is in sale or not.
   */
   ...
   * The price without any discount.
   */
  priceUndiscounted: ProductDetails_product_category_products_edges_node_defaultVariant_pricing_priceUndiscounted | null;
  /**
   * The price, with any discount subtracted.
   */
  price: ProductDetails_product_category_products_edges_node_defaultVariant_pricing_price | null;
}

export interface ProductDetails_product_category_products_edges_node_defaultVariant_attributes_attribute_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_attributes_attribute {
  __typename: "Attribute";
  /**
   * The ID of the object.
   */
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetails_product_category_products_edges_node_defaultVariant_attributes_attribute_metadata | null)[];
}

export interface ProductDetails_product_category_products_edges_node_defaultVariant_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: ProductDetails_product_category_products_edges_node_defaultVariant_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (ProductDetails_product_category_products_edges_node_defaultVariant_attributes_values | null)[];
}

export interface ProductDetails_product_category_products_edges_node_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetails_product_category_products_edges_node_defaultVariant {
   ...
   * List of images for the product variant.
   */
  images: (ProductDetails_product_category_products_edges_node_defaultVariant_images | null)[] | null;
  weight: ProductDetails_product_category_products_edges_node_defaultVariant_weight | null;
  /**
   * Lists the storefront variant's pricing, the current price and discounts, only meant for displaying.
   */
  pricing: ProductDetails_product_category_products_edges_node_defaultVariant_pricing | null;
  /**
   * List of attributes assigned to this variant.
   */
  attributes: ProductDetails_product_category_products_edges_node_defaultVariant_attributes[];
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetails_product_category_products_edges_node_defaultVariant_metadata | null)[];
}
...
export interface ProductDetails_product_variants_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetails_product_variants {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetails_product_variants_metadata | null)[];
}
...
export interface ProductDetails_product_defaultVariant_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface ProductDetails_product_defaultVariant {
   ...
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (ProductDetails_product_defaultVariant_metadata | null)[];
}
